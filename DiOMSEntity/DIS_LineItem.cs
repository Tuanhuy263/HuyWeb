namespace DiOMSEntity
{
    ...
    public partial class DIS_LineItem
    {
        ...
        public int? WSTShipmentAdviceCartonID { get; set; }
        ...
        [StringLength(100)]
        public string GS1ICasePackID { get; set; }

        [StringLength(100)]
        public string CasePack_Serial { get; set; }

        [StringLength(100)]
        public string CasePack_LotNo { get; set; }

        public DateTime? CasePack_ExpiredDate { get; set; }
        ...
        public virtual DIS_Carton DIS_Carton1 { get; set; }

        public virtual DIS_Carton DIS_Carton2 { get; set; }
